  ...
  return (
    <div className="min-h-screen flex flex-col items-center text-white px-0 py-0">
      <div className="w-full max-w-[1400px] px-8 md:px-16 lg:px-24 pt-32 pb-16 mx-auto">
        ...
        <div className="flex justify-center mb-16 space-x-4 md:space-x-6 font-medium text-lg md:text-xl uppercase">
          {" "}
          {/* Adjusted spacing and font */}
          {(
            [
              "ALL",
              "NARRATIVE",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 md:gap-8 justify-items-center">
          {" "}
          {/* Changed xl:grid-cols-4 to xl:grid-cols-3 to match PPT */}
